...
#include "../Lab3/intervalTimer.h"  // Modify as necessary to point to your intervalTimer.h
...
int main() {
    ...
    while (FOREVER) {               // Endless loop.
        ...
        wamDisplay_drawSplashScreen(false);  // Draw the game splash screen.
        ...
        wamDisplay_drawMoleBoard(false);             // Draw the WAM mole board.
        ...
        wamDisplay_drawGameOverScreen(false);        // Draw the game-over screen.
