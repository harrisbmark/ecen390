...
void verifySequence_drawButtons() {
    display_fillScreen(DISPLAY_BLACK);  // Clear the screen.
    simonDisplay_drawButton(BUTTON_0, false);  // Draw the four buttons.
    simonDisplay_drawButton(BUTTON_1, false);
    simonDisplay_drawButton(BUTTON_2, false);
    simonDisplay_drawButton(BUTTON_3, false);
}
