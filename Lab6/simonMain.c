...
int main() {
    ...
    // Initialization of the simon display is not time-dependent, do it outside of the state machine.
    simonControl_initialize_display();
    ...
    //while (interrupts_isrInvocationCount()
    //        < (TOTAL_SECONDS * privateTimerTicksPerSecond)) {
    while (true)  {
